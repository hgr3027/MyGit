...
public final class ServiceManager {
    ...
    public void startService(String userId,String userCompany) {    
    	final String myuserId = userId;
		final String myUserCompany = userCompany;
        Thread serviceThread = new Thread(new Runnable() {
            @Override
            public void run() {
                Intent intent = NotificationService.getIntent();
                intent.setPackage("com.example.newpie");
                sharedPrefs = context.getSharedPreferences(
                        Constants.SHARED_PREFERENCE_NAME, Context.MODE_PRIVATE);
                Editor editor = sharedPrefs.edit();
                editor.putString("myUserId", myuserId);
                editor.putString("myUserCompany", myUserCompany);                
                editor.commit();
