...
public class DatabaseManager {
	...
	public static String uid_Produce(Context context) {
		...
		if (settings.getString("device_imei", "").equals("") == true) {
			...
			if ((serial_number == null || serial_number.equals(""))) {
				int rendom_number = (int) (Math.random() * 1 + 1) + (int) (Math.random() * 10 + 1) + (int) (Math.random() * 100 + 1)
						+ (int) (Math.random() * 1000 + 1) + (int) (Math.random() * 10000 + 1) + (int) (Math.random() * 100000 + 1)
						+ (int) (Math.random() * 1000000 + 1) + (int) (Math.random() * 10000000 + 1);
	...
	public long addDevice(String dev_nickname, String dev_uid, String dev_name, String dev_pwd, String view_acc, String view_pwd,
			int event_notification, int channel) {
	...
	public long addDevice(String dev_nickname, String dev_uid, String dev_name, String dev_pwd, String view_acc, String view_pwd,
			int event_notification, int channel, boolean sync) {
	...
	public void updateDeviceInfoByDBID(long db_id, String dev_uid, String dev_nickname, String dev_name, String dev_pwd, String view_acc,
			String view_pwd, int event_notification, int channel) {
...
//		db.update(TABLE_DEVICE_CHANNEL, values, "dev_uid_and_channel = '" + dev_uid_and_channel + "'", null);
	...
	private class DatabaseHelper extends SQLiteOpenHelper {
		...
		private static final String SQLCMD_CREATE_TABLE_DEVICE = "CREATE TABLE " + TABLE_DEVICE + "("
				+ "_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, " + "dev_nickname			NVARCHAR(30) NULL, " + "dev_uid				VARCHAR(20) NULL, "
				+ "dev_name				VARCHAR(30) NULL, " + "dev_pwd				VARCHAR(30) NULL, " + "view_acc				VARCHAR(30) NULL, "
				+ "view_pwd				VARCHAR(30) NULL, " + "event_notification 	INTEGER, " + "ask_format_sdcard		INTEGER," + "camera_channel			INTEGER, "
				+ "snapshot				BLOB," + " sync				INTEGER" + ");";

		private static final String SQLCMD_CREATE_TABLE_SEARCH_HISTORY = "CREATE TABLE " + TABLE_SEARCH_HISTORY + "("
				+ "_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, " + "dev_uid			VARCHAR(20) NULL, " + "search_event_type	INTEGER, "
				+ "search_start_time	INTEGER, " + "search_stop_time	INTEGER" + ");";

		private static final String SQLCMD_CREATE_TABLE_SNAPSHOT = "CREATE TABLE " + TABLE_SNAPSHOT + "("
				+ "_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, " + "dev_uid			VARCHAR(20) NULL, " + "file_path			VARCHAR(80), "
				+ "time				INTEGER" + ");";

		private static final String SQLCMD_CREATE_TABLE_REMOVE_LIST = "CREATE TABLE " + TABLE_REMOVE_LIST + "("
		...
		private static final String SQLCMD_CREATE_TABLE_CAMERA = "CREATE TABLE " + TABLE_DEVICE_CHANNEL + "("
				+ "_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, " + "dev_uid				VARCHAR(20) NULL, " + "channel_name				VARCHAR(30) NULL, "
