...
public class EventListActivity extends SherlockActivity implements IRegisterIOTCListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ImageButton searchBtn = (ImageButton) this.findViewById(R.id.bar_right_imgBtn);
		searchBtn.setVisibility(View.VISIBLE);
		searchBtn.setBackgroundDrawable(getResources().getDrawable(R.drawable.ic_menu_search));
