...
public class LinkDropBoxActivity extends SherlockActivity implements IRegisterIOTCListener, View.OnClickListener {
	...
	private void initCameraList() 
	{
		for(int i=0;i<MultiViewActivity.DeviceList.size();i++)
		{
			...
			MultiViewActivity.CameraList.get(i).sendIOCtrl(MyCamera.DEFAULT_AV_CHANNEL, AVIOCTRLDEFs.IOTYPE_USER_IPCAM_GET_SAVE_DROPBOX_REQ,"0".getBytes());
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) 
			{
				case AVIOCTRLDEFs.IOTYPE_USER_IPCAM_GET_SAVE_DROPBOX_RESP:
					...
					//String MacAddress = MainActivity.getMacAddress(LinkDropBoxActivity.this).toString();
...
//					}
	...
	@SuppressLint("NewApi") private class DeviceListAdapter extends BaseAdapter {
							...
							boolean arg1) 
					{
				        ...
				        if (arg1) 
				        {
				        	...
				        	cam.sendIOCtrl(MyCamera.DEFAULT_AV_CHANNEL, AVIOCTRLDEFs.IOTYPE_USER_IPCAM_SET_SAVE_DROPBOX_REQ,
				        			AVIOCTRLDEFs.SMsgAVIoctrlSetDropbox.parseContent(1, DatabaseManager.uid_Produce(LinkDropBoxActivity.this).toString() ,getKeys()[0],getKeys()[1], APP_KEY ,APP_SECRET,"0"));
				        } 
				        else 
				        {
				        	//arg0.setChecked(false);
				        	cam.sendIOCtrl(MyCamera.DEFAULT_AV_CHANNEL, AVIOCTRLDEFs.IOTYPE_USER_IPCAM_SET_SAVE_DROPBOX_REQ,
				        			AVIOCTRLDEFs.SMsgAVIoctrlSetDropbox.parseContent(0, DatabaseManager.uid_Produce(LinkDropBoxActivity.this).toString(), getKeys()[0],getKeys()[1], APP_KEY ,APP_SECRET,"0"));
				        }
					}
				});
