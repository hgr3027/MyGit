...
public class IOTC_GCM_IntentService extends IntentService 
{
		...
		private void showNotification(String dev_uid,String dev_alert) 
		{
			...
			try {
				...
				Cursor cursor = db.query(DatabaseManager.TABLE_DEVICE, new String[] { "_id", "dev_nickname", "dev_uid", "dev_name", "dev_pwd", "view_acc", "view_pwd", "event_notification", "camera_channel", "snapshot", "ask_format_sdcard" }, null, null, null, null, "_id LIMIT " + MultiViewActivity.CAMERA_MAX_LIMITS);
				int nNotification = -1;
