...
public class MultiViewStatusBar {
    ...
    public void ChangeStatusBar(int Index,DeviceInfo device,Monitor monitor)
    {
    	if(Layout==null)
    		return;
    	...
    	{	
    		...
    		if(device.Online)
    		{
    			icon_status.setBackgroundResource(R.drawable.online);
    		...
    		{
    			icon_status.setBackgroundResource(R.drawable.offline);
