...
public class UITableView extends LinearLayout {
		...
		if(mItemList.size() > 1) {
			...
			for(IListItem obj : mItemList) {
				...
				if(mIndexController == 0) {
					tempItemView = mInflater.inflate(R.layout.leo_list_item_top, null);
				}
				else if(mIndexController == mItemList.size()-1) {
					tempItemView = mInflater.inflate(R.layout.leo_list_item_bottom, null);
				}
				else {
					tempItemView = mInflater.inflate(R.layout.leo_list_item_middle, null);
				}	
			...
			View tempItemView = mInflater.inflate(R.layout.leo_list_item_single, null);
	...
	private void setupBasicItem(View view, BasicItem item, int index) {
		if(item.getDrawable() > -1) {
			//if(((TextView) view.findViewById(R.id.image))!=null)
		...
		if(item.isClickable()) {
			...
			//if(((ImageView) view.findViewById(R.id.chevron))!=null)
